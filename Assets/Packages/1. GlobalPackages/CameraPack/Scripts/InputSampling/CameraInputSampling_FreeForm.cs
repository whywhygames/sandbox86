    ...
    public class CameraInputSampling_FreeForm : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (inputFreeLook || cameraMode == CameraMode.Always)
            {
                ...
                //print(TCKInput.GetTouchPhase(InputParametrs.Touchpad));


                if (TCKInput.GetTouchPhase(InputParametrs.Touchpad) != ETouchPhase.NoTouch)
                {
                ...
                y = (mouseInvertY ? (look.y * -1.0f) : look.y) * mouseSensitivity.y;
